...
constexpr int NUMBER_OF_SEPERATING_AXES = 15;
...
public:
	...
	int				getaxesCount() { return NUMBER_OF_SEPERATING_AXES; }
...
private:
	...
	NMath::Vector3   axes[NUMBER_OF_SEPERATING_AXES];  // The normalised axes to test against in global space.
};